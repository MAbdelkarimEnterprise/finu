...
export default function Hero() {
  ...
  return (
    <section className="hero" aria-label="Finu — AI financial assistant">
      ...
      <div className="hero-content mx-auto flex min-h-[inherit] max-w-[1360px] flex-col justify-center px-5 pb-32 pt-32 md:px-8 md:pb-24 lg:pt-36">
        <div className="grid items-center gap-16 lg:grid-cols-[1.05fr_0.95fr] lg:gap-10">
          <div className="max-w-xl">
            ...
            <TextReveal
              as="h1"
              delay={0.3}
              className="f-display mt-6 text-[clamp(2.5rem,6vw,4.3rem)]"
            >
